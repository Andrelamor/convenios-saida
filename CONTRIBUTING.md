...
- [Issues](https://github.com/dados-mg/convenios-saida/issues): Para iniciar uma discussão sobre melhorias na documentação.
- [Pull requests](https://github.com/dados-mg/convenios-saida/pulls): Para sugerir uma alteração concreta na documentação.
